            ...
            <center>
                ...
                <div class="card" style="display: flex; justify-content: center; padding-bottom: 16px;">
                    ...
                    <div class="card-body" style="padding-top: 0px; padding-bottom: 0px;">
                        ...
                        <p class="card-text">Like many PC gamers we use bundle services, such as Humble Bundle, for game keys.</p>

                        <p class="card-text">And like most who use these services, we have an abundance of keys for games that don't appeal to us.</p>

                        <p class="card-text">So we had an idea...</p>

                        <p class="card-text">Instead of trading keys between ourselves and others, on forums and groups.</p>

                        <p class="card-text">A platform should be created.</p>

                        <p class="card-text">One that offers a safe place for those interested.</p>
